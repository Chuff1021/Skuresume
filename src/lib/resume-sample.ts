...
export function createSampleResumeData(overrides?: Partial<{ template: string; primary: string }>): ResumeData {
  return {
    ...
    metadata: {
      ...
      page: { gapX: 20, gapY: 18, marginX: 62, marginY: 56, format: "letter", hideIcons: false },
      design: {
        colors: { primary: overrides?.primary || "#0F4C81", text: "#1F2937", background: "#FFFFFF" },
        level: { type: "rectangle" },
      },
      typography: {
        body: { fontFamily: "Source Serif 4", fontWeight: 400, fontSize: 11, lineHeight: 1.45 },
        heading: { fontFamily: "Inter", fontWeight: 700, fontSize: 26, lineHeight: 1.15 },
      },
      notes: "",
    },
  };
