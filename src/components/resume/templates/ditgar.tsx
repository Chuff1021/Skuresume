...
// Ditgar: Left accent borders with tinted sidebar and inverted sidebar header
export function DitgarTemplate({ data }: { data: ResumeData }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Sidebar header - solid primary background with inverted text */}
        <div
          style={{
        ...
        >
          ...
          {basics.headline && (
            <p style={{ fontSize: bf.fontSize, opacity: 0.85, marginTop: 4 }}>
              {basics.headline}
            </p>
          )}
        </div>

        {/* Sidebar content - tinted background */}
        <div
          style={{
            padding: `${m.gapY}px ${m.marginX * 0.7}px ${m.marginY}px`,
            display: "flex",
            flexDirection: "column",
            gap: m.gapY,
          }}
        >
          {/* Contact */}
          <div>
            <SidebarHeading title="Contact" color={colors.primary} hf={hf} />
            <div
              style={{
                display: "flex",
                flexDirection: "column",
      ...
      >
        ...
        {summary && (
          <div>
            ...
            <AccentItem color={colors.primary}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {sections.experience.items
                .filter((i) => !i.hidden)
                .map((item) => (
                  <AccentItem key={item.id} color={colors.primary}>
